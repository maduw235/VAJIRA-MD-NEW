...
module.exports = {
SESSION_ID: process.env.SESSION_ID === undefined ? 'VAJIRA-MD=CMdnCRxQ#HNvnzDCZoEkD20y4Dw3QDAiu-Ugoy-mE47-2s7olpXM' : process.env.SESSION_ID,
OWNER_NUMBER: process.env.OWNER_NUMBER === undefined ? '94715922193' : process.env.OWNER_NUMBER,   
